...
#define SERIALCOMMANDBUFFER_SIZE 32			// was 16
#define MAXSERIALCOMMANDS	25				// was 10
...
class SerialCommand
{
	...
	private:
		...
		char buffer[SERIALCOMMANDBUFFER_SIZE];   // Buffer of stored characters while waiting for terminator character
		...
		{
			char command[SERIALCOMMANDBUFFER_SIZE];
			void (*function)();
